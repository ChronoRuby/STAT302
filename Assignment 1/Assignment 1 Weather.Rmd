...
``` {r echo = FALSE}
weather.barplot <- ggplot(data = Bikeshare) + geom_bar(mapping = aes(x = weather)) + labs(title = "Types of Weather Across 2011-2012") + scale_x_continuous(breaks = c(1, 2, 3), labels = c("Clear/partly cloudy", "mist/cloudy/partly cloudy", "light rain/snow"))
